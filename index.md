...
humandate: "September 1, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10am-5pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
email: ["pab2163@columbia.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
